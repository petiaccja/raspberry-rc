...
public class Message {
	/** The instuction's code. */
	public RCInstruction instruction;
	/** Parameter #1 of instuction. */
	public int param1;
	/** Parameter #2 of instuction. */
	public int param2;
 ...
 * The instruction and all parameters are converted to big-endian streams.
 * Nothing else is sent, only the above-mentioned values. Java serialization
 * cannot be used, since it stores class and other information unnecessary and
 * ununderstandable for other languages.
 */
